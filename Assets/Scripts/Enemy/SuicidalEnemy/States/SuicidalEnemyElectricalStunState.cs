...
public class SuicidalEnemyElectricalStunState : IState
{
    
#region Constructor
    SuicidalEnemyController m_enemyController;
    public SuicidalEnemyElectricalStunState(SuicidalEnemyController enemyController)
    {
    ...
    public void FixedUpdate()
    {
        ...
        if (m_timer > m_enemyController.EnemyChara._enemyCaractéristique._stunResistance.timeOfElectricalStunResistance && !m_timerIsDone)
        {
            m_timerIsDone = true;
